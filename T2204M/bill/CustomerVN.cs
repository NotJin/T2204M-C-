...
namespace T2204M.bill
{
    public class CustomerVN
    {
        ...
        public CustomerVN(int code, string fullName, string date, int quantity)
        {
            ID = code;
            FullName = fullName;
            Date = date;
    ...
    public class KhachHangNN : CustomerVN
    {
        public KhachHangNN()
        {
    ...
    public class KhachHangVN : CustomerVN
    {
        public KhachHangVN()
        {

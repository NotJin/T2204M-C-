...
namespace T2204M.managerStudent
{
     class StudentReport
    {
        private List<Student> ListSinhVien = null;

        public StudentReport()
        {
            ListSinhVien = new List<Student>();
        }
        ...
        {
            ListSinhVien.Sort(delegate (Student sv1, Student sv2) {
         ...
         */
        private void XepLoaiHocLuc(Student sv)
        {
            if (sv.DiemTB >= 8)
            {
                sv.HocLuc = "Gioi";
